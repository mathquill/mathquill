...
var SVG_SYMBOLS = {
  'sqrt': {
    html:
      '<svg style="width:100%; height: 100%" preserveAspectRatio="none" viewBox="0 0 32 54">' +
  ...
  '[': {
    width: '.55em',
    html:
      '<svg style="width:100%; height: 100%" preserveAspectRatio="none" viewBox="0 0 11 24">' +
  ...
  '(': {
    width: '.55em',
    html:
      '<svg style="width:100%; height: 100%" preserveAspectRatio="none" viewBox="3 0 106 186">' +
  ...
  '{': {
    width: '.7em',
    html:
      '<svg style="width:100%; height: 100%;" preserveAspectRatio="none" viewBox="10 0 210 350">' +
