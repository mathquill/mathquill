...
# With that in mind, you can now understand Cursor's tree traversal and manipulation methods in frontend.js.
## Before you dig in to Cursor.prototype, take peek at RootMathBlock.prototype.keydown()
...
## after that, you can read through Cursor's Math DOM tree traversal and manipulation methods.
