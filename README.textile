...
2. With that in mind, you can skip to the tree traversal and manipulation in frontend.js.
    1. Start with RootMathBlock.prototype.keydown(),
    ...
    2. after that, you can take a peek at Cursor's Math DOM tree traversal and manipulation methods.
