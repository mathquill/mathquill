...
# To get a general idea of our program model, you want to start by skimming backend.js.
...
# With that in mind, you can skip to the tree traversal and manipulation in frontend.js.
## Start with RootMathBlock.prototype.keydown(),
##* notice how varies keystrokes, such as arrow keys, map to methods of Cursor
...
## after that, you can take a peek at Cursor's Math DOM tree traversal and manipulation methods.
...
## Now check out how RootMathBlock.prototype.keypress() calls Cursor.prototype.write()
